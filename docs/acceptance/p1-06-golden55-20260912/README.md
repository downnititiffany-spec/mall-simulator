...
7. 8090/8092 仍未启动（按 F-07 停机纪律：P1-06 完成后再恢复三程序运行）。
   **（2026-09-12 09:55 补记，不改上文）**：该项已闭环——09:40:49 起 8090（pid 41228）、09:48:10 起 8092（pid 10412），三处健康均 200，8091 未重启；证据见 `docs/acceptance/m1-4-restock-20260912/raw/restock-20260912-095320.log`。**同时**：落地区自 09:53:26 起新增 `2026091209.jsonl`（55→56 文件），故本文 §4/§6 引用的"落地区 55 文件"仅是 **2026-09-12 09:2x–09:3x 冻结窗口内**的口径，之后引用必须注明时点。
