...
- `项目完整实施指导书 V2.3.md`：三程序边界、商城无关化、集群、数据结构、算法、测试，以及受控 AI 数仓设计规则（**最高实施依据**）。2026-09-12 由 V2.2 迭代（相对 V2.2 的唯一实质变化＝新增 §4.1.1「核心接口的追认与补全」；V2.2 转历史、正文逐字未改）。
...
- `项目完整实施指导书 V2.1.md`、`项目完整实施指导书 V2.2.md`（2026-09-12 起）、`项目实施进度与任务看板.md`、`开发过程事实与决策记录.md`：历史快照，只读追溯；不再作为当前执行入口。
