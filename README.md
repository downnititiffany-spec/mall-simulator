...
| 阶段 | 内容 | 状态 |
|---|---|---|
| 1 | 契约与基准：事件 Schema、指标字典、黄金数据 | 🚧 进行中 |
| 2 | 最小商城：商品、购物车、下单、支付、退款与 Outbox | 🚧 进行中 |
| 3 | 自动生成：场景、分布、随机种子和脏数据 | 未开始 |
| 4 | 环境与采集：LOCAL 环境 + Flume，再验证远程集群 | 未开始 |
| 5 | 数仓与 Spark：ODS、DWD、DWS、ADS、算法和质量规则 | 未开始 |
| 6 | 指标服务：快照发布和 MySQL MetricStore | 未开始 |
| 7 | Web 程序：权限、运行中心和普通员工分析页面 | 未开始 |
| 8 | AI 与决策：证据解释、受控查询、报告和决策闭环 | 未开始 |
| 9 | 测试与实验：功能、性能、恢复、对照和安全实验 | 未开始 |
| 10 | 论文与答辩 | 未开始 |
