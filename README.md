...
> 当前实施依据：[`docs/项目完整实施指导书 V2.0.md`](docs/项目完整实施指导书%20V2.0.md)（最高依据）。
> [`docs/项目整改实施指导书 V1.0.md`](docs/项目整改实施指导书%20V1.0.md) 是整改初期的历史依据，仅在 V2.0 未覆盖处参考。

## 1. 当前真实状态（截至 2026-09-11，均为实测）
...
| 文档 | 说明 |
|---|---|
| [`docs/项目完整实施指导书 V2.0.md`](docs/项目完整实施指导书%20V2.0.md) | 当前实施依据（最高） |
| [`docs/design/项目设计文稿 V2.2.md`](docs/design/基于Spark大数据平台和智能分析模型的电商用户行为分析系统设计与实现——项目设计文稿%20V2.2.md) | 完整设计方案；V1.0、V2.1 为历史版本 |
...
修改任何文稿前，先把原文件复制到 `docs/backups/` 并带日期或阶段名；结论以《项目完整实施指导书 V2.0》与最新整改状态为准，
